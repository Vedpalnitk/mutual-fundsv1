...
export class BusinessIntelligenceController {
  ...
  getAumByClient(@CurrentUser() user: AuthenticatedUser, @Query('topN') topN?: string) {
  ...
  getAumSnapshots(@CurrentUser() user: AuthenticatedUser, @Query('days') days?: string) {
  ...
  getNetFlows(@CurrentUser() user: AuthenticatedUser, @Query('months') months?: string) {
  ...
  getSipHealth(@CurrentUser() user: AuthenticatedUser) {
  ...
  getRevenueProjection(@CurrentUser() user: AuthenticatedUser) {
  ...
  @ApiQuery({ name: 'topN', required: false, type: Number })
  getClientConcentration(@CurrentUser() user: AuthenticatedUser, @Query('topN') topN?: string) {
  ...
  getDormantClients(@CurrentUser() user: AuthenticatedUser) {
  ...
  getMonthlyScorecard(@CurrentUser() user: AuthenticatedUser) {
  ...
  getRevenueAttribution(@CurrentUser() user: AuthenticatedUser) {
  ...
  getClientSegmentation(@CurrentUser() user: AuthenticatedUser) {
  ...
  triggerSnapshot(@CurrentUser() user: AuthenticatedUser) {
